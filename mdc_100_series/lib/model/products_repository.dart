...
class ProductsRepository {
  static List<Product> loadProducts(CategoryOne category) {
    const allProducts = <Product>[
      Product(
        category: CategoryOne.accessories,
        id: 0,
        isFeatured: true,
        name: 'Vagabond sack',
        price: 120,
